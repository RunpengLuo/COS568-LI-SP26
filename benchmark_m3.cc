                    ...
                    const std::string& only, const std::string& /*filename*/)
{
  ...
  check_only("HybridPGMLIPPM3", benchmark_64_hybrid_pgm_lipp_m3(benchmark));
}
...
int main(int argc, char* argv[]) {
  cxxopts::Options options("benchmark_m3", "Searching on sorted data benchmark (Milestone 3)");
