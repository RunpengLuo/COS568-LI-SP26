#ifndef TLI_DYNAMIC_PGM_M2_H
#define TLI_DYNAMIC_PGM_M2_H
...
class DynamicPGMM2 : public Competitor<KeyType, SearchClass> {
 public:
  DynamicPGMM2(const std::vector<int>& params) {}
  ...
  std::string name() const { return "DynamicPGMM2"; }
