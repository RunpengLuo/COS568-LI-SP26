...
echo "Executing Milestone 3 benchmarks..."
...
for DATA in "${DATASETS[@]}"; do
    ...
    for INDEX in LIPP DynamicPGM HybridPGMLIPPM3; do
...
mv ./results/*_mix_results_table.csv ./results_m3/ 2>/dev/null || true

for FILE in ./results_m3/*.csv; do
    [ -f "$FILE" ] || continue
